...
export const CARDS: DareCard[] = [
  ...
  // --- ULTRA FUN & PLAYFUL (231-245) ---
  { id: '231', type: 'fun', text: 'Do your best impression of me when I get hungry or hangry.', timer: 30 },
  { id: '232', type: 'fun', text: 'Try to make me laugh without talking, using only hand gestures and body language.', timer: 45 },
  { id: '233', type: 'fun', text: 'Let me blindfold you and put something from the fridge on your tongue — you must guess what it is.' },
  { id: '234', type: 'fun', text: 'Sing the chorus of your most guilty pleasure song in an overly dramatic opera voice.', timer: 30 },
  { id: '235', type: 'fun', text: 'Pretend to be a telemarketer passionately trying to sell me a subscription to "Dating You".', timer: 45 },
  { id: '236', type: 'fun', text: 'Do 10 jumping jacks while naming one thing you love about me with every single jump.', timer: 40 },
  { id: '237', type: 'fun', text: 'Swap phone wallpapers with me for the next 24 hours.' },
  { id: '238', type: 'fun', text: 'Talk in slow motion like you are in a 90s action film for the next 2 minutes.', timer: 120 },
  { id: '239', type: 'fun', text: 'Let me give you a completely new hairstyle using whatever hair clips, scrunchies, or gel is nearby.' },
  { id: '240', type: 'fun', text: 'Reenact our very first disagreement or awkward moment together as a dramatic telenovela.' },
  { id: '241', type: 'fun', text: 'Try to do a plank for 30 seconds while I tell you bad jokes to make you collapse.', timer: 30 },
  { id: '242', type: 'fun', text: 'Show me your screen time report for today without hiding anything.' },
  { id: '243', type: 'fun', text: 'Speak only in compliments for the next 3 rounds — any insult or sarcasm loses 2 points!' },
  { id: '244', type: 'fun', text: 'Let me text any single emoji of my choice to anyone in your recent chats.' },
  { id: '245', type: 'fun', text: 'Do a 20-second catwalk across the room treating our hallway like a Paris fashion show.', timer: 20 },

  // --- DEEP ROMANTIC & INTIMATE (246-260) ---
  { id: '246', type: 'romantic', text: 'Hold my face with both hands, look directly into my eyes, and tell me the moment you felt most lucky to have me.' },
  { id: '247', type: 'romantic', text: 'Give me a slow, soothing neck and shoulder massage with warm lotion for 2 minutes.', timer: 120 },
  { id: '248', type: 'romantic', text: 'What is one promise about our future you want to make to me right now?' },
  { id: '249', type: 'romantic', text: 'Trace my lips with your thumb, then give me the softest kiss you can manage.' },
  { id: '250', type: 'romantic', text: 'Play our favorite song, pull me close with zero space between us, and slow dance until it ends.' },
  { id: '251', type: 'romantic', text: 'Tell me 3 specific moments from this past week where I made you feel deeply appreciated.' },
  { id: '252', type: 'romantic', text: 'Whisper 5 things you find irresistibly attractive about me that have nothing to do with looks.' },
  { id: '253', type: 'romantic', text: 'Write a secret 5-word love note on a piece of paper, fold it, and hide it in my pocket or bag for later.' },
  { id: '254', type: 'romantic', text: 'Rest your head on my chest, close your eyes, and just breathe together in silence for 60 seconds.', timer: 60 },
  { id: '255', type: 'romantic', text: 'Tell me the sweetest memory of us that you replay in your head whenever you miss me.' },
  { id: '256', type: 'romantic', text: 'Kiss every single fingertip on my left hand while telling me what each finger represents.' },
  { id: '257', type: 'romantic', text: 'Describe what you think our life will look like 5 years from today in cozy detail.' },
  { id: '258', type: 'romantic', text: 'Give me a lingering kiss on my forehead, both cheeks, and finish with a slow kiss on my lips.' },
  { id: '259', type: 'romantic', text: 'Tell me the one thing I do that makes your heart beat faster every single time.' },
  { id: '260', type: 'romantic', text: 'Cuddle me from behind, wrap your arms tight around my waist, and whisper a sweet secret in my ear.' },

  // --- SPICY HEAT & PASSION (261-280) ---
  { id: '261', type: 'spicy', intensity: 1, text: 'Gently bite my lower lip while kissing me, then pull back slowly with eye contact.' },
  { id: '262', type: 'spicy', intensity: 1, text: 'Run your fingers through my hair, tilt my head back, and kiss my throat.' },
  { id: '263', type: 'spicy', intensity: 1, text: 'Whisper into my ear the outfit you find most seductive on me and why.' },
  { id: '264', type: 'spicy', intensity: 1, text: 'Trace your lips along my jawline from my ear to my chin without kissing.' },
  { id: '265', type: 'spicy', intensity: 2, text: 'Take an ice cube, run it across my collarbone and neck, and follow the trail with your warm lips.', timer: 45 },
  { id: '266', type: 'spicy', intensity: 2, text: 'Pull me into your lap, place your hands on my hips, and deliver a passionate 20-second kiss.', timer: 20 },
  { id: '267', type: 'spicy', intensity: 2, text: 'Slowly remove one item of my clothing using only one hand.' },
  { id: '268', type: 'spicy', intensity: 2, text: 'Blindfold me for 2 minutes — tease me with kisses on any 3 spots you choose, but not my lips.', timer: 120 },
  { id: '269', type: 'spicy', intensity: 2, text: 'Guide my hands all over your body while you describe exactly what you want me to do next.' },
  { id: '270', type: 'spicy', intensity: 2, text: 'Give me a teasing lap dance to the next song that plays on your phone.', timer: 45 },
  { id: '271', type: 'spicy', intensity: 2, text: 'Place your hand over my chest to feel my heartbeat, look in my eyes, and kiss me like it is our last night.' },
  { id: '272', type: 'spicy', intensity: 2, text: 'Unbutton or slide down my top slightly and kiss the bare skin along my shoulders.' },
  { id: '273', type: 'spicy', intensity: 3, text: 'Pin my wrists above my head gently and tease my lips for 30 seconds without kissing fully.', timer: 30 },
  { id: '274', type: 'spicy', intensity: 3, text: 'Tell me in graphic detail what you want to do to me tonight when the game ends.' },
  { id: '275', type: 'spicy', intensity: 3, text: 'Kiss your way down my neck, stomach, and thighs, taking a full 60 seconds.', timer: 60 },
  { id: '276', type: 'spicy', intensity: 3, text: 'Take off one more piece of clothing slowly while maintaining unbroken eye contact.' },
  { id: '277', type: 'spicy', intensity: 3, text: 'Let me give you a 2-minute sensual full-body oil rub while you remain completely still.', timer: 120 },
  { id: '278', type: 'spicy', intensity: 3, text: 'Whisper your deepest, darkest bedroom fantasy that you have never admitted to anyone before.' },
  { id: '279', type: 'spicy', intensity: 3, text: 'Straddle my hips and let me have zero control — you decide everything for the next 2 minutes.', timer: 120 },
  { id: '280', type: 'spicy', intensity: 3, text: 'Turn off the lights, leave only candlelight or screen glow, and let your hands do the talking.' },

  // --- LDR CONNECTION & LONG-DISTANCE ROMANCE (281-295) ---
  { id: '281', type: 'ldr', vibe: 'romantic', text: 'Send me a photo of your hand right against the camera — I will match my hand on screen so we "touch".' },
  { id: '282', type: 'ldr', vibe: 'fun', text: 'Let us order food or snacks for each other on Swiggy/Zomato/UberEats without revealing what it is until delivery!' },
  { id: '283', type: 'ldr', vibe: 'romantic', text: 'Send a 20-second video recording of you whispering what you would do if you could teleport into my room right now.' },
  { id: '284', type: 'ldr', vibe: 'spicy', intensity: 2, text: 'Get on video call, turn down your room lighting, and describe our first kiss upon reunion.' },
  { id: '285', type: 'ldr', vibe: 'fun', text: 'Draw a funny doodle or portrait of me on paper in 30 seconds and hold it up to the camera.', timer: 30 },
  { id: '286', type: 'ldr', vibe: 'romantic', text: 'Put your phone on your pillow next to your face so we can fall asleep together on call.' },
  { id: '287', type: 'ldr', vibe: 'spicy', intensity: 2, text: 'Send me the spicy selfie you almost took or hesitated to send before.' },
  { id: '288', type: 'ldr', vibe: 'fun', text: 'Change your display name or status to something cute chosen by me for the next 24 hours.' },
  { id: '289', type: 'ldr', vibe: 'romantic', text: 'Play the same song at the exact same second and close your eyes while listening together on call.' },
  { id: '290', type: 'ldr', vibe: 'fun', text: 'Show me the contents of your nightstand or pocket right now without cleaning anything up.' },
  { id: '291', type: 'ldr', vibe: 'spicy', intensity: 3, text: 'Describe in a 30-second voice note exactly what you are wearing to bed and how you want to be held.', timer: 30 },
  { id: '292', type: 'ldr', vibe: 'romantic', text: 'Record a voice note singing our couple song, even if off-key — I want to hear your voice.' },
  { id: '293', type: 'ldr', vibe: 'fun', text: 'Find 3 items in your room that are the exact same color as my eyes or favorite outfit.' },
  { id: '294', type: 'ldr', vibe: 'spicy', intensity: 2, text: 'Blow a slow kiss to the screen and bite your lip while looking into the camera lens.' },
  { id: '295', type: 'ldr', vibe: 'romantic', text: 'Tell me the exact countdown of days or weeks until our next hug, and plan day one.' }
];
